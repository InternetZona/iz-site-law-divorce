<header class="header container">
    <div class="header__grid grid">
        ...
        <div class="col s12 m4 l5">
            <a href="#modal-order" class="header__btn header__btn--solid btn waves-effect waves-light waves-ripple modal-trigger">Заказать услугу</a>
            <a href="#modal-feedback" class="header__link modal-trigger hide-on-med-and-down">Задать вопрос</a>
        </div>
    </div>
</header>